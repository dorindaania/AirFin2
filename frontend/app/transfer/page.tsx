...
import { TrendingUp, Check, DollarSign, AlertCircle, ArrowLeft } from "lucide-react"
...
export default function TransferPage() {
  ...
  // Destination accounts (excluding the source account)
  ...
  useEffect(() => {
    if (accountId) {
      ...
      if (foundAccount) {
        ...
        // Set destination accounts (excluding the source account)
        setDestinationAccounts(accounts.filter((acc) => acc.id !== accountId))
      } else {
    ...
    <div className="pt-16 flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="md:ml-72 md:mx-8 mx-4">
        ...
        <div className="flex items-center mt-8 mb-6">
          ...
          <h1 className="text-3xl text-slate-900 font-bold">Transfer Funds</h1>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          {success ? (
            <Card className="p-8 text-center">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-slate-600 mb-4">
                  ₵{amount} has been transferred from your {account.accountType} at {account.bankName} to{" "}
                  {destinationAccounts.find((acc) => acc.id === destinationAccount)?.bankName ||
            ...
            <form onSubmit={handleSubmit}>
              <Card className="mb-6">
                <div className="p-4">
                  <h2 className="text-xl font-semibold text-slate-900 mb-4">Source Account</h2>
              ...
              <Card className="mb-6">
                <div className="p-4">
                  <h2 className="text-xl font-semibold text-slate-900 mb-4">Transfer Amount</h2>
              ...
              <Card className="mb-6">
                <div className="p-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="destinationAccount" className="block text-sm font-medium text-slate-700 mb-1">
                        Destination Account
                      </label>
                      <select
              ...
              <div className="flex justify-end">
                ...
                <button
                  type="submit"
                  disabled={!amount || !description || !destinationAccount || isSubmitting}
